...
TWILIO_ACCOUNT_SID = os.getenv('TWILIO_ACCOUNT_SID', 'ACa58e5d71b82a166aa33bb9f1c37e9d22')
TWILIO_AUTH_TOKEN = os.getenv('TWILIO_AUTH_TOKEN', 'd5449ef48c110c6c104ac59ae276d2fe')
TWILIO_PHONE_NUMBER = os.getenv('TWILIO_PHONE_NUMBER', '+2132635338')
...
# TWILIO_ACCOUNT_SID = os.getenv('TWILIO_ACCOUNT_SID', 'AC0a8e940a64f34356ad286610ab428a7a')
# TWILIO_AUTH_TOKEN = os.getenv('TWILIO_AUTH_TOKEN', 'ebd0cef9ce64fb4c45afd4d38a918be6')
# TWILIO_PHONE_NUMBER = os.getenv('TWILIO_PHONE_NUMBER', '+18507417476')
# USER_PHONE_NUMBER = '+918804339456'
...
# # Suggest doctor based on the maximum matching symptoms
# def suggest_doctor(df, user_symptoms, payment_status, patient_id):
#     user_symptoms_list = clean_user_input(user_symptoms)
#     if not user_symptoms_list:
#         return {"message": "🤔 No symptoms provided. Please specify your symptoms clearly."}
...
#             f"🔍 ** For {specialization}**: {doctor_name}",
#             f"🏢 **Room Number**: {room_number}",
#             f"👤 **Patient ID**: {patient_id}",  # Include patient ID in the message
#             "\nPlease feel free to consult them for the best care! 💖"
#         ]
...
#     symptoms = data.get("symptoms", "")
#     payment_status = data.get("payment_status", False)
#     patient_id = data.get("patient_id", "")  # Get patient ID from the request data

#     result = suggest_doctor(df, symptoms, payment_status, patient_id)
#     return jsonify(result)
