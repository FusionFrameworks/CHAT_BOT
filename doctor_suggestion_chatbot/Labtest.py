...
# Twilio Credentials
TWILIO_ACCOUNT_SID = os.getenv('TWILIO_ACCOUNT_SID', 'ACcd15fc3bff46f3a7f67daf0468bda614')
TWILIO_AUTH_TOKEN = os.getenv('TWILIO_AUTH_TOKEN', '2fe10f5a680969a7254244ded540a2c7')
TWILIO_PHONE_NUMBER = os.getenv('TWILIO_PHONE_NUMBER', '+13203563140')
