...
const Chatbot = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await fetch("https://l7xqlqhl-5000.inc1.devtunnels.ms/suggest_doctor", {
        method: "POST",
        headers: {
        ...
        try {
          ...
          if (sessionResponse.status === 200) {
            ...
            const doctorResponse = await fetch(
              "https://l7xqlqhl-5000.inc1.devtunnels.ms/suggest_doctor",
              {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
...
//     const symptomsArray = userInput.split(",").map((symptom) => symptom.trim());
//     if (symptomsArray.length < 3) {
//       setResponses((prevResponses) => [
//         ...prevResponses,
//         {
//           text: "🤔 Please provide at least 3 symptoms for a proper doctor suggestion.",
//           sender: "bot",
//         },
//       ]);
//       setUserInput("");
...
//       const feeMatch = data.message.match(/(?:\d+\.?\d*)/);
//       if (feeMatch) setConsultationFee(parseFloat(feeMatch[0]));
//     } catch (error) {
//       setResponses((prevResponses) => [
//         ...prevResponses,
//         { text: `Error: ${error.message || "Unable to reach backend."}`, sender: "bot" },
//       ]);
//     }
...
//         toast.success("Payment Successful! You can now consult with the doctor.", {
//           position: "top-right",
//           autoClose: 5000,
//           theme: "colored",
//           transition: Bounce,
...
//           setResponses((prevResponses) => [
//             ...prevResponses,
//             { text: `Error: ${error.message || "Process failed."}`, sender: "bot" },
//           ]);
//         }
//       },
//       prefill: {
...
//   const handleClearChat = () => {
//     setUserInput("");
//     setResponses([{ text: "👋 Welcome to the Health Chatbot! How can I assist you today?", sender: "bot" }]);
//     setStoredSymptoms("");
